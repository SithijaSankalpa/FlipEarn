...
export const getChat = async (req, res) =>{
  try {
    ...
    if(existingChat){
      ...
      return res.json({chat: existingChat}); // Move return here
    }
...
// Controller for getting all chate for user
...
export const sendChatMessage = async (req, res) => {
  try {
    ...
    // ✅ Capture the created message with its id
    ...
    res.json({message: "Message sent", newMessage}); // ✅ Now includes id
