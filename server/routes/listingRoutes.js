...
import { addCredengtial, addlisting, deleteUserListing, getAllPublicListing, getAllUserListing, getAllUserOrders, markFeatured, purchaseAccount, toggleStatus, updateListing, withdrawAmount } from "../controllers/listingController.js";
...
listingRouter.post('/add-credential', protect, addCredengtial)
