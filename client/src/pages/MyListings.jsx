  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 pt-8 '>
      ...
      <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-8'>
        ...
        <StatCard title='Total Value' value={`${currency}${totalValue.toLocaleString()}`} icon={<DollarSign 
        className='size-6 text-yellow-600' />} color='yellow' />  
      </div>
          {/* Balance Section */}
                                      ...
                                      <div className='flex justify-between items-start'>
                                        ...
                                        <div className='flex items-center gap-2'>
                                                        ...
                                                        <button className='text-nowrap'>
                                                         ...
                                                         <span className={
                                                          ...
                                                          listing.isCredentialVerified 
                                                              ...
                                                              {listing.isCredentialSubmitted 
                                                                ? (listing.isCredentialVerified 
                                                                    ? (listing.isCredentialChanged ? "Changed" : "Verified")
                                           ...
                                           {listing.status === "active" && (
                                            <StarIcon onClick={()=>markAsFeatured(listing.id)} size={18} className={`text-yellow-500 cursor-pointer ${
