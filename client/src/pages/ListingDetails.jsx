            ...
            <div className='flex items-start max-md:flex-col gap-10'>        
              <div className='flex-1 max-md:w-full'>
                ...
                <div className='bg-white rounded-xl border border-gray-200 p-6 mb-5'>
                  ...
                  <div className='flex items-center gap-3'>
                    <div className='p-2 rounded-xl bg-gray-50'>{platformIcons[listing.platform]}</div>                   
                      <div>
                    ...
                    {images?.length > 0 && (
                      <div className='bg-white rounded-xl border border-gray-200 mb-5 overflow-hidden'>
                        ...
                        <div className='relative w-full aspect-video overflow-hidden'>
                            ...
                            {/* Navigate Button */}
                            <button onClick={prevSlide} className='absolute left-3 top-1/2 -translate-y-1/2 bg-white hover:bg-gray-100 p-2 rounded-full shadow'>
                                <ChevronLeftIcon className='w-5 h-5 text-gray-700'/>
                            </button>
                            <button onClick={nextSlide} className='absolute right-3 top-1/2 -translate-y-1/2 bg-white hover:bg-gray-100 p-2 rounded-full shadow'>
                    ...
                    <div className='bg-white rounded-xl border border-gray-200 mb-5'>
                      ...
                      <div className='grid grid-cols-1 md:grid-cols-2 gap-6 p-4 text-sm'>
                        ...
                        <div>
                          ...
                          <p className='font-medium capitalized'>{listing.status}</p>
                        </div>
                      </div>
                    </div>    
                 </div>
              ...
              <div className='bg-white border-t border-gray-200 p-4 text-center mt-28'>
                <p className='text-sm text-gray-500'>
                  © 2025 <span className='text-indigo-600'>Sithija Sankalpa</span>. All rights reserved.
                </p>
              </div>
    </div>
  ) : (
